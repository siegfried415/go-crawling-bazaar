...
func InitFSRepo(targetPath string, version uint, cfg *conf.Config) error {
...
func InitFSRepoDirect(targetPath string, version uint, cfg *conf.Config) error {
...
//wyong, 20201002 
func (r *FSRepo) SetConfig(cfg *conf.Config) error {
	r.lk.Lock()
	defer r.lk.Unlock()
...
func (r *FSRepo) Config() *conf.Config {
	r.lk.RLock()
	defer r.lk.RUnlock()
...
func (r *FSRepo) ReplaceConfig(cfg *conf.Config) error {
...
func (r *FSRepo) SnapshotConfig(cfg *conf.Config) error {
...
func initConfig(p string, cfg *conf.Config) error {
