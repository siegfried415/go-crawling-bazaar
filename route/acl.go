...
const (
	...
	FronteraBidding
	FronteraBid 
	FronteraURLCidRequest //wyong, 20200818
...
func (s RemoteFunc) String() string {
	...
	//wyong, 20200729 
	case FronteraURLRequest:
		return "Frontera.ReceiveUrlRequest"
	case FronteraBidding:
		return "Frontera.ReceiveBiddingMessage"
	case FronteraBid:
		return "Frontera.ReceiveBidMessage"

	//wyong, 20200818 
	case FronteraURLCidRequest:
		return "Frontera.ReceiveUrlCidRequest"
