...
func (z *UrlRequest) MarshalHash() (o []byte, err error) {
	//fmt.Printf("UrlRequest/MarshalHash(10), stack=%s\n", callinfo.Stacks())
...
func (z *UrlRequestMessage) MarshalHash() (o []byte, err error) {
	fmt.Printf("UrlRequestMessage/MarshalHash(10), stack=%s\n", callinfo.Stacks())
...
func (z *UrlRequestMessage) Msgsize() (s int) {
	s = 1 + 9 + z.Envelope.Msgsize() + 7 + 1 + 14 + z.Header.UrlRequestHeader.Msgsize() + 28 + z.Header.DefaultHashSignVerifierImpl.Msgsize() + 8 + 1 + 8 + hsp.ArrayHeaderSize
	for za0001 := range z.Payload.Requests{
...
func (z *SignedUrlRequestHeader) Msgsize() (s int) {
	s = 1 + 28 + z.DefaultHashSignVerifierImpl.Msgsize() + 14 + z.UrlRequestHeader.Msgsize()
	return
}
