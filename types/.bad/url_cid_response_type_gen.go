...
func (z *UrlCidResponse) Msgsize() (s int) {
	s = 1 + 7 + 1 + 15 + z.Header.UrlCidResponseHeader.Msgsize() + 13 + z.Header.UrlCidResponseHash.Msgsize() + 8 + z.Payload.Msgsize()
	return
}
...
func (z *UrlCidResponsePayload) MarshalHash() (o []byte, err error) {
	...
	*/
	...
	for za0001 := range z.Cids {
		o = hsp.AppendBytes(o, z.Cids[za0001].Bytes() )
	}
...
func (z *UrlCidSignedResponseHeader) Msgsize() (s int) {
	s = 1 + 13 + z.UrlCidResponseHash.Msgsize() + 15 + z.UrlCidResponseHeader.Msgsize()
	return
}
