...
func (z *CreateDomain) MarshalHash() (o []byte, err error) {
	var b []byte
	o = hsp.Require(b, z.Msgsize())
	// map header, size 3
	o = append(o, 0x83)
	if oTemp, err := z.CreateDomainHeader.MarshalHash(); err != nil {
		return nil, err
	} else {
...
// MarshalHash marshals for hash
func (z *CreateDomainHeader) MarshalHash() (o []byte, err error) {
	var b []byte
	o = hsp.Require(b, z.Msgsize())
	// map header, size 6
	o = append(o, 0x86)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *CreateDomainHeader) Msgsize() (s int) {
